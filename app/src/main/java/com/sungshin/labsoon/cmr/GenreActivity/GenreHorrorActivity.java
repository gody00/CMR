...
public class GenreHorrorActivity extends AppCompatActivity {
    ImageView home_btn;
    String search[] = {"의", "을", "이"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView = (View) View.inflate(GenreHorrorActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 40, MaxDate, 2014, "4");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreHorrorActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreHorrorActivity.this, MainActivity.class);
