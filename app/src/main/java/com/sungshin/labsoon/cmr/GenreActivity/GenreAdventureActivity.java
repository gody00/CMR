...
public class GenreAdventureActivity extends AppCompatActivity {
    ImageView home_btn;
    String search[] = {"의","을","이","가"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genre_adventure);
        home_btn = (ImageView) findViewById(R.id.home_btn);
        naverService = ApplicationController.getInstance().getNaverService();
        dialogView = (View) View.inflate(GenreAdventureActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 40, MaxDate, 2014, "6");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreAdventureActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreAdventureActivity.this, MainActivity.class);
