...
public class GenreDramaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView = (View) View.inflate(GenreDramaActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 40, MaxDate, 2014, "1");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreDramaActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreDramaActivity.this, MainActivity.class);
