...
public class GenreThrillerActivity extends AppCompatActivity {
    ImageView home_btn;
    String search[] = {"의", "을", "이"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView = (View) View.inflate(GenreThrillerActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 50, MaxDate, 2014, "7");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreThrillerActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreThrillerActivity.this, MainActivity.class);
