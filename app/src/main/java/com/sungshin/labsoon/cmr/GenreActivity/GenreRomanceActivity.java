...
public class GenreRomanceActivity extends AppCompatActivity {
    ImageView home_btn;
    String search[] = {"우리","이","사랑"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView = (View) View.inflate(GenreRomanceActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 40, MaxDate, 2014, "5");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreRomanceActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreRomanceActivity.this, MainActivity.class);
