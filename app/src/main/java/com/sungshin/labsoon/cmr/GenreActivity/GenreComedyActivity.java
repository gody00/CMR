...
public class GenreComedyActivity extends AppCompatActivity {
    ImageView home_btn;
    String search[] = {"의", "을", "이"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genre_comedy);
        home_btn = (ImageView) findViewById(R.id.home_btn);

        naverService = ApplicationController.getInstance().getNaverService();
        dialogView = (View) View.inflate(GenreComedyActivity.this, R.layout.dialog2, null);
        ...
        for (int i = 0; i < search.length; i++) {
            ...
            if (Check) {
                ...
                Call<MovieDataResult> getMovieData = naverService.getMovieDataResult(query, 1, 40, MaxDate, 2014, "11");
    ...
    private View.OnClickListener recyclerClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try{
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(GenreComedyActivity.this);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.home_btn:
                    Intent intentHome = new Intent(GenreComedyActivity.this, MainActivity.class);
